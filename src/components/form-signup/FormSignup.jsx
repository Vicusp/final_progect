    ...
    return (
        <div className={css.registration}>
            <div className={css.container}>
                <h1 className={css.title}>Регистрация в сервисе<br /> "Поиск велосипедов"</h1>
            ...
            <p className={css.attribution}>На странице использовано: <a href="https://img.freepik.com/free-vector/bike-trial-concept-illustration_114360-9860.jpg?t=st=1668423517~exp=1668424117~hmac=41cc8084e2a06037ebc2aa4495122f154d1c528975a6cb79847d28af412d6bec">Изображение от free-vector на Freepik</a></p>
        </div>
    )
}
